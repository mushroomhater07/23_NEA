...

{
   ...
   public void LoadSetting()
   {
       ...
       xSenS.value= float.Parse(result[0]);
       ySenS.value= float.Parse(result[1]);
       MusicVolS.value = float.Parse(result[2]);
       sfxVolS.value	= float.Parse(result[3]);
       
       cameraFOVS.value= float.Parse(result[4]);
       minimapSizeS.value= float.Parse(result[5]);
       joystickSizeS.value= float.Parse(result[6]);
