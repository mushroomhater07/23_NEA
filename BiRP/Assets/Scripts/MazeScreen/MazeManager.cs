...
public class MazeManager : MonoBehaviour
{
    ...
    public void Dead()
    {
        mainchar.GetComponent<movement>()._animator.SetTrigger("dead");
    ...
    public void StartGame()
    {
        ...
        Debug.Log(movementScript.GetComponentInChildren<Animator>());
        ...
        movementScript._animator = movementScript.GetComponentInChildren<Animator>();
