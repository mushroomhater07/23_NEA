...
return;
    ...
    // var result = Task.Run(() =>Singleton.CsharpAPI.GetData(true, "SELECT * FROM Leaderboard;","")).Result;
     // var result = Task.Run(() =>Singleton.Localdb.Query( "SELECT exit FROM GAMEDATA","setting")).Result
    // .Split(new char[]{',',';'})[0]
